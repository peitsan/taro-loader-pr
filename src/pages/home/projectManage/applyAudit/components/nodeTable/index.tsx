...
import ITable from '../quesTable/type';

export const NodTable: FC<ITable> = (props: ITable) => {
    ...
    <>
      ...
      <AtFloatLayout
        ...
        <View className={styles.moreData}>
          ...
          {/* @ts-ignore */}
          <View>计划完成时间: {data[clickIndex]?.planTime}</View>
          {/* @ts-ignore */}
          <View>申请调整时间: {data[clickIndex]?.adjustTime}</View>
          {/* @ts-ignore */}
          <View>调整原因: {data[clickIndex]?.adjustReason}</View>
