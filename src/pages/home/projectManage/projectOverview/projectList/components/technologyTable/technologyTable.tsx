import { Empty, Spin, Modal, Input, Form, Button, message } from 'antd';
...
export const TechnologyTable: React.FC = () => {
  ...
  const parameterList = ['opinion','situation','mainAdviceOpinion','questionExecute',]
  ...
  const showModal = (e: React.MouseEvent<HTMLDivElement, MouseEvent>, id:number | null)=>{
              ...
              recordList.map((item,index)=>{
                return (
                  <div className={styles['technologyTable-item']} key={index}>
                    ...
                    <div>{item.依据}</div>
                    <div 
                      style={{color : item.审核意见 === null ? '#cfcfcf' : 'black'}}>
                      {item.审核意见 === null ? '暂未填写' : item.审核意见}
                    </div>
                    <div 
                      style={{color : item.闭环情况 === null ? '#cfcfcf' : 'black'}}>
              ...
              <div className={styles['signature-input']}>
                ...
                >
                  ...
                  <div className={styles['content']}>
                    <div className={styles['all-content']} style={{color : opinion === null ? '#cfcfcf' : 'black'}}>
                ...
                >
                  ...
                  <div className={styles['content']}>
                    <div className={styles['all-content']} style={{color : situation === null ? '#cfcfcf' : 'black'}}>
